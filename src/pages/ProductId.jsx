...
import { Breadcrumb, Card, Carousel, Col, Container, Row, Stack } from 'react-bootstrap'
        ...
        <Row>
          ...
          <Col>
            <div className='card-description-container'>
              ...
              <button className='btn-end' onClick={addProduct}>Add to cart</button>
            </div>
          </Col>
        </Row>
      </Container>
        ...
        {filterSimilarItems.map((product) => (
          <Col key={product.id}>
            <Card
              ...
              className='center-card-flex center-card-flex--productid'
            >
